...
export default function PublicationsCarousel({ publications }: PublicationsCarouselProps) {
  ...
  return (
    ...
    >
      ...
      {showThumbnail && <div className="absolute inset-0 z-10 bg-black/40 pointer-events-none" />}
      ...
      <div className="absolute inset-0 z-20 flex flex-col px-6 py-5 sm:px-14 sm:py-7 lg:px-20">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11.5px] text-[#c3cee0] font-medium">{formatDate(current.date, locale)}</span>
        </div>
