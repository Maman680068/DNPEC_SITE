...
export default function OrgChartMobile() {
  ...
  return (
    <div className="lg:hidden flex flex-col items-center gap-3">
      ...
      <div className="text-navy/30 text-lg leading-none">▾</div>
      ...
      <div className="text-navy/30 text-lg leading-none mt-1">▾</div>
      ...
      <div className="w-full max-w-xs bg-navy text-white text-center font-bold rounded-md py-3 px-4 text-sm mt-2">
